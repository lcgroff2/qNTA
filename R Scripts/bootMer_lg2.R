customBootMer <- function (x, FUN, nsim = 1, seed = NULL, use.u = FALSE, re.form = NA, 
          type = c("parametric", "semiparametric"), verbose = FALSE, 
          .progress = "none", PBargs = list(), parallel = c("no", 
                                                            "multicore", "snow"), ncpus = getOption("boot.ncpus", 
                                                                                                    1L), cl = NULL) 
{
...
environment(customBootMer) <- asNamespace('lme4')
assignInNamespace("bootMer", customBootMer, ns = "lme4")